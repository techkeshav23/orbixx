      ...
      <section id="trainers" className="py-20 md:py-28 bg-slate-50">
        <div className="max-w-7xl mx-auto px-5 sm:px-6 lg:px-8">
          <div className="text-center max-w-2xl mx-auto mb-16">
            <p className="text-[#FF6B4A] font-semibold text-sm tracking-wide uppercase mb-3">
              Our Team
            </p>
          ...
          <div className="grid md:grid-cols-3 gap-6 max-w-5xl mx-auto">
            {trainers.map((trainer, index) => (
              <div
                key={index}
                className="bg-white rounded-2xl border border-slate-200 hover:border-[#FF6B4A]/30 hover:shadow-xl hover:shadow-[#FF6B4A]/5 transition-all duration-300 overflow-hidden group"
              >
                <div className="relative bg-gradient-to-br from-[#FF6B4A]/5 to-[#EC4899]/5 px-6 pt-8 pb-6 text-center">
                  <div className="w-20 h-20 mx-auto rounded-full border-2 border-[#FF6B4A]/20 overflow-hidden mb-4 group-hover:scale-105 transition-transform duration-300">
                    <Image
                      src={trainer.image}
                      alt={trainer.name}
                      width={80}
                  ...
                  <p className="text-slate-500 text-sm mt-1">{trainer.role}</p>
                  <div className="absolute top-4 right-4 flex items-center gap-1 bg-amber-50 rounded-lg px-2 py-1 border border-amber-100">
                    <svg className="w-3.5 h-3.5 text-amber-400" fill="currentColor" viewBox="0 0 20 20">
                      <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" />
                    </svg>
                    <span className="text-amber-700 text-xs font-semibold">{trainer.rating}</span>
                  </div>
                </div>
                ...
                <div className="grid grid-cols-3 border-b border-slate-100">
                  ...
                  <div className="text-center py-4">
                    <p className="text-[#FF6B4A] font-bold text-xs">{trainer.specialty}</p>
