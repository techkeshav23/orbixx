...
import { INSTAGRAM_URL, LINKEDIN_URL, YOUTUBE_URL, WHATSAPP_URL } from "@/lib/constants";
    ...
    <footer id="contact" className="bg-slate-900 text-white">
      ...
      <div className="max-w-7xl mx-auto px-5 sm:px-6 lg:px-8 py-12 md:py-16">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 lg:gap-12">
          ...
          {/* Contact */}
          <div>
            <h4 className="text-sm font-semibold uppercase tracking-wide text-slate-300 mb-4">Contact</h4>
          ...
          {/* CTA */}
          <div>
            <h4 className="text-sm font-semibold uppercase tracking-wide text-slate-300 mb-4">Get Started</h4>
