        ...
        <div className="grid lg:grid-cols-2 gap-10 sm:gap-16 lg:gap-24 items-center">
          ...
          >
            <div className="relative">
              ...
              <div className="lg:aspect-[4/5] rounded-3xl overflow-hidden relative bg-gradient-to-br from-white via-slate-50 to-white border border-slate-200 shadow-sm">
                ...
                <div className="relative lg:absolute lg:inset-0 flex flex-col items-center justify-center py-8 px-5 sm:p-8">
